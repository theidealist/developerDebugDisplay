...
#ifndef  _DDD__DISPLAY_INTERFACE__CLICK_EVENT_HANDLER_H_
#define  _DDD__DISPLAY_INTERFACE__CLICK_EVENT_HANDLER_H_
...
#endif   // _DDD__DISPLAY_INTERFACE__CLICK_EVENT_HANDLER_H_
